# 需要的配置
import redis
redis_store = redis.Redis(host='172.21.200.168', port=6379, db=1)  # 操作的redis配置
...
class DevelopmentConfig(Config):
    ...
    SESSION_REDIS = redis.Redis(host='172.21.200.168', port=6379, db=2)  # 操作的redis配置
    DEBUG = True

# 线上环境
class ProductionConfig(Config):
    """生产环境配置信息"""
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:root123@127.0.0.1:3306/iechemistry'
